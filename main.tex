...
тестовом кадре YOLO26n был медленнее (11.8~мс против 9.5~мс/кадр),
...
\begin{enumerate}
  ...
  \item \textbf{Детектор номерных знаков.}
        ...
        668 изображений, 50 эпох, batch=16, SGD, lr=0.01) позволил
        достичь mAP@0.50\,=\,0.9554. Дообученный на тех же данных YOLO26n
