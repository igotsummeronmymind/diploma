...
Kaggle car-plate-detection). Детектор номерных знаков YOLO26n (fine-tuned) достиг
mAP@0.50\,=\,0.9669, превысив YOLOv8n fine-tuned (0.9554).
Классификатор цвета ResNet18 достиг Accuracy top-1\,=\,0.922.
Классификатор типа кузова ResNet18~--- Accuracy top-1\,=\,0.784.
EasyOCR обеспечивает CRR\,=\,0.975 на синтетических номерах
и CRR\,=\,0.750 на реальных данных NOMEROFF-NET~RU (2845~кропов).
Проведено сравнительное исследование ResNet18 и MobileNetV2.
